...
model_output_path = os.path.join(model_folder, "final_ch1_cnnSingleChannel.pth")

batch_id = time.strftime("%Y%m%d_%H%M%S")
run_folder = os.path.join(outputs_folder, f"ch1_10runs_{batch_id}")
os.makedirs(run_folder, exist_ok=True)

all_trials_path = os.path.join(run_folder, "ch1_all_trial_stats.csv")
...
# random.seed(seed)
    ...
    run_trials_path = os.path.join(run_folder, f"ch1_trial_stats_run_{run_number:02d}.csv")
